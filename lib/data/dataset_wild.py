...
def read_input(json_path, vid_size, scale_range, focus, skip_trans=False):
...
class WildDetDataset(Dataset):
    def __init__(self, json_path, clip_len=243, vid_size=None, scale_range=None, focus=None, skip_trans=False):
        self.json_path = json_path
        self.clip_len = clip_len
        self.vid_all = read_input(json_path, vid_size, scale_range, focus, skip_trans)
